...
The goal of `DrakeCallJulia` is to create a toy example of how Julia and R can be used together in a [Drake](https://github.com/ropensci/drake) project using the [JuliaCall](https://github.com/Non-Contradiction/JuliaCall) R package and the [RCall](https://github.com/JuliaInterop/RCall.jl) Julia package.
